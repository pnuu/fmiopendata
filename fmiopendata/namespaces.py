...
"""Namespaced element paths used to read the FMI XML documents."""

EF_BELONGS_TO = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}belongsTo"
EF_ENVIRONMENTAL_MONITORING_FACILITY = ".//{http://inspire.ec.europa.eu/schemas/ef/4.0}EnvironmentalMonitoringFacility"
